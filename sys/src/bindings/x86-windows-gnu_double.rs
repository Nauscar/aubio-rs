...
pub const AUBIO_SMPL_FMT: &[u8; 4] = b"%lf\0";
...
const _: () = {
    ["Size of fvec_t"][::std::mem::size_of::<fvec_t>() - 8usize];
    ["Alignment of fvec_t"][::std::mem::align_of::<fvec_t>() - 4usize];
    ["Offset of field: fvec_t::length"][::std::mem::offset_of!(fvec_t, length) - 0usize];
    ["Offset of field: fvec_t::data"][::std::mem::offset_of!(fvec_t, data) - 4usize];
};
extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of cvec_t"][::std::mem::size_of::<cvec_t>() - 12usize];
    ["Alignment of cvec_t"][::std::mem::align_of::<cvec_t>() - 4usize];
    ["Offset of field: cvec_t::length"][::std::mem::offset_of!(cvec_t, length) - 0usize];
    ["Offset of field: cvec_t::norm"][::std::mem::offset_of!(cvec_t, norm) - 4usize];
    ["Offset of field: cvec_t::phas"][::std::mem::offset_of!(cvec_t, phas) - 8usize];
};
extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lvec_t"][::std::mem::size_of::<lvec_t>() - 8usize];
    ["Alignment of lvec_t"][::std::mem::align_of::<lvec_t>() - 4usize];
    ["Offset of field: lvec_t::length"][::std::mem::offset_of!(lvec_t, length) - 0usize];
    ["Offset of field: lvec_t::data"][::std::mem::offset_of!(lvec_t, data) - 4usize];
};
extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of fmat_t"][::std::mem::size_of::<fmat_t>() - 12usize];
    ["Alignment of fmat_t"][::std::mem::align_of::<fmat_t>() - 4usize];
